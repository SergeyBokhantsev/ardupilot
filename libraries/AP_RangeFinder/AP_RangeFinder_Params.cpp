...
const AP_Param::GroupInfo AP_RangeFinder_Params::var_info[] = {
    ...
    // @Description: This sets the bus address of the sensor, where applicable. Used for the I2C sensors to allow for multiple sensors on different addresses. A value of 0 disables the sensor.
    // @Range: 0 127
    // @Increment: 1
    // @User: Standard
